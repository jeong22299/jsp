...
/*
 	...
 	인수(Argument)로서, 함수선언, 객체생성 및 메서드 정의랑 때 사용된다.
...
class Juicer {
//	static <T extends Fruit>void makeJuice(FruitBox<T> box) {	// 제한된 타입 파라미터
	static void makeJuice(FruitBox<? extends Fruit> box) {		// 와일드카드 
