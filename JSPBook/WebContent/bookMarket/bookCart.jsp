 	...
 	<div class="container">
 		<div class="row">
 			<table width="100%">
 				<tr>
 					<td align="left">
 						<a href="deleteBookCart.jsp?cartId=<%=cartId%>"
 							class="btn btn-danger">삭제하기</a>
 					</td>
 					<td align="right">
 						<a href="bookShippingInfo.jsp?cartId=<%=cartId%>"
 		...
 		<div style="padding-top: 50px;"> <!-- padding-top : 영역 위쪽 여백 -->
 			<table class="table table-hover">
 				...
 				<tr>
 					<td><%=book.getName()%></td>
 					<td><fmt:formatNumber value="<%=book.getUnitPrice()%>" pattern="#,###" /></td>
 					<td><%=book.getQuantity()%></td>
 					<td><fmt:formatNumber value="<%=totalBig%>" pattern="#,###" /></td>
 					<td><a href="removeBookCart.jsp?id=<%=book.getBookId()%>" class="btn btn-outline-danger btn-sm">삭제</a></td>
 				</tr>
 				<%	
 						}	// end for
 						// 소수점 제거
