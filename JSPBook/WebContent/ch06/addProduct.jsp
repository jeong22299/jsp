...
<body>
	...
	<!-- 
		현재 로케일에 따라 리소스 번들이 위치한/src/bundle/패키지(디렉터리)에
		message.properties를 가져오도록 basenane 속성을 작성함.
	 -->
 		...
 		<form name="newProduct" action="processAddProduct.jsp"
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10">
					<input type="button" class="btn btn-primary" value="<fmt:message key="title" />"
