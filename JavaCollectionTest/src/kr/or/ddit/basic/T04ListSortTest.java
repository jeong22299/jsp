...
public class T04ListSortTest {
	public static void main(String[] args) {
		...
		Member mem1 = new Member(1, "홍길동", "010-111-1111");
		Member mem2 = new Member(1, "홍길동", "010-111-1111");
		...
		memList.add(new Member(5, "변학도", "010-222-222"));
		memList.add(new Member(9, "성춘향", "010-333-3333"));
		memList.add(new Member(3, "이순신", "010-444-4444"));
		memList.add(new Member(6, "강감찬", "010-555-5555"));
		memList.add(new Member(2, "일지매", "010-666-6666"));
...
class Member implements Comparable<Member> {
	...
	/*
	 *  회원 이름을 기준으로 오름차순 정렬이 될 수  있도록 작성하기 
	 */
