...
//		System.out.println("출력 끝...");
		...
		// 2) 응답결과가 1개일 경우...
		System.out.println("select 연습시작(결과가 1개인 경우...");
		
		// 응답결과가 1개가 확실할 경우에는 selectOne()메서드를 사용한다.
		MemberVO mv3 = 
				(MemberVO)sqlSession.selectOne("memberTest.getMember", "a001");
