...
#in1 {
	border: 1px solid rgb(219, 217, 217); width : 500px;
	height: 50px;
	font-size: 12px;
	width: 500px;
}
	...
	<div id=wrapper align="center">
		...
		<div id=table>
			<form action="<%=request.getContextPath()%>/SearchId.do"
				...
				<table id=table1>
					...
					<tbody>
						<tr
							...
							<td>
								<div id=a>
									&nbsp;&nbsp;&nbsp;&nbsp;<input id=in1 type="text" title="이름"
										name="memNm" placeholder="&nbsp;&nbsp;이름을 입력해 주세요.">
								</div>
							</td>
						</tr>
						<tr
				...
				<br> <a href="login.jsp"> <input id=in2 type="button" value="이전" style="background-color: rgb(91,96,110)" ></a> 
